...
select 
distinct(concat(mem.firstname,'', mem.surname) as fullname
, lower(fac.name) as courtname
...
where date(book.starttime) = '2012-09-04'
having cost > 30
order by cost desc
